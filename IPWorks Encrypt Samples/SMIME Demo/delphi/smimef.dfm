object FormSmime: TFormSmime
  ...
  object Label1: TLabel
    ...
    Height = 39
    Caption = 
      'This idemo shows how to use the features of the SMIME component.' +
      ' Fill in the text area below and then select an action to perfor' +
      'm on that text. '
    WordWrap = True
  end
  ...
  object ipcCertMgr1: TipcCertMgr
    CertStore = 'MY'
    Left = 472
    Top = 8
  end
  object ipcSmime1: TipcSMIME
    CertStore = 'MY'
