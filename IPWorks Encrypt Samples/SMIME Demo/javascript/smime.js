...
const smime = new ipworksencrypt.smime();
			...
			case 'encryptop':
				...
				switch (choiceEnc) {
					case '1': //Encrypt
						...
						try {	
							await smime.getRecipientCerts().add(new ipworksencrypt.Certificate(8, recipientCertFile, "", "*"));
							await smime.encrypt();
						} catch (e) {
							console.log(e);
							process.exit();
					...
					case '2': //Sign
						...
						try {
							await smime.setCertificate(new ipworksencrypt.Certificate(2, myCertFile, "password", "*"));
							await smime.sign();
						} catch (e) {
							console.log(e);
							process.exit();
